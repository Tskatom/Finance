...
def get_term_list(domain,predict_date,stock_index,duration=1):
...
def main():
    ...
    surrogateDomain = get_domain(conn,'t_surrogatedata')
    warningDomain = get_domain(conn,'t_warningmessage')
