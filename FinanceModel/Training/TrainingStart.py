...
def parse_args():
    ...
    ap.add_argument('-k',dest="key_numbers",type=int,nargs='?',default=150,help='The number of key words')
    ap.add_argument('-clu',dest="c_numbers",type=int,nargs='?',default=10,help='The numberf of clusters')
